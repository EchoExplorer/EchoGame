...
data = cursor.execute("SELECT * FROM GameData")

with open('/var/www/output.csv', 'wb') as f:
    writer = csv.writer(f)
...
print "<body>"
print "<h1> Success!</h1>" 
print "Click <a href=\"http://merichar-dev.eberly.cmu.edu:81/output.csv\">here</a> to download."
print "</body>"
print "</html>"
