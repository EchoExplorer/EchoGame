...
cursor.execute('''
            ...
            currentLevel INTEGER, trackCount INTEGER, crashCount INTEGER, stepCount INTEGER,        
...
cursor.execute('''
            ...
            currentLevel INTEGER, trackCount INTEGER,  echo TEXT, echoLocation TEXT,
            postEchoAction TEXT, correctAction TEXT, dateTimeStamp TEXT)''')

cursor.execute("DROP TABLE IF EXISTS CrashData")
cursor.execute('''
            CREATE TABLE CrashData(id INTEGER PRIMARY KEY, userName TEXT,
            currentLevel INTEGER, trackCount INTEGER, crashNumber INTEGER, crashLocation TEXT,
            dateTimeStamp TEXT)''')
