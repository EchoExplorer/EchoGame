...
public class Database : MonoBehaviour
{
    ...
    void LoadData()
    {
        ...
        TitleCmdlistClips[0] = Resources.Load("instructions/Tap once with three fingers to hear an echo") as AudioClip;
        TitleCmdlistClips[1] = Resources.Load("instructions/To open or close the pause menu, tap and hold with three fingers for 1 second") as AudioClip;
        TitleCmdlistClips[2] = Resources.Load("instructions/Swipe up to move forward") as AudioClip;
        TitleCmdlistClips[3] = Resources.Load("instructions/To turn right, rotate three fingers clockwise about 90 degrees, or rotate them counterclockwise to turn left") as AudioClip;
        TitleCmdlistClips[4] = Resources.Load("instructions/Swipe down to attempt to exit") as AudioClip; // TODO: Change to triple tap
        TitleCmdlistClips[5] = Resources.Load("instructions/2sec_silence") as AudioClip;
        //Main_pre
        ...
        MainPreGameClips[2] = Resources.Load("instructions/Tap once with three fingers to confirm you want to start a new game") as AudioClip;
        ...
        MainPreConfirmClips[1] = Resources.Load("instructions/Swipe left with three fingers to start a new game, or swipe down with three fingers to go back to the main menu") as AudioClip;
