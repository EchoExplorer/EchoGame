...
//ONLY meant to take down constants
//Place to tweak the feeling of games
//Please don't add any more Game Loop code here
public class Const : MonoBehaviour {
	...
	public const float echoTapTime = 0.15f;//tap for how long to get an echo
